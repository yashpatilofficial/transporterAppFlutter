...
class NearbyTruckCard extends StatefulWidget {
  var deviceList;
  var gpsData;
  //String status;
  var imei;
  ...
  @override
  _NearbyTruckCardState createState() => _NearbyTruckCardState();
}

class _NearbyTruckCardState extends State<NearbyTruckCard> {
  ...
  void initState() {
    super.initState();
    //truckNo = widget.deviceList.truckno;
    try {
      initfunction();
    } catch (e) {}
  }
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text("Tyre: ${widget.deviceList.tyre}",
                                // "Truck Travelled : ",
                                softWrap: true,
                                style: TextStyle(
                                    color: black,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text("Truck Type: ${widget.deviceList.category}",
                                // "Truck Travelled : ",
                                softWrap: true,
                                style: TextStyle(
                                    color: black,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text("Owner: ${widget.deviceList.contact}",
                                // "Truck Travelled : ",
                                softWrap: true,
                                style: TextStyle(
                                    color: black,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text(
                                "Passing Weight: ${widget.deviceList.passingWeight} Tonnes",
                                // "Truck Travelled : ",
                                softWrap: true,
                                style: TextStyle(
                                    color: black,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text("Contact: ${widget.deviceList.phone}",
                                // 'Ignition  :',
                                style: TextStyle(
                                    color: black,
                                    fontSize: size_6,
